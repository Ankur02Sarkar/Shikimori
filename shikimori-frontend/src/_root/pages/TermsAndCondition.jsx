  ...
  return (
    <>
        ...
        <div className="w-full h-full min-h-dvh mt-12">
          <div className="flex flex-row items-center justify-between gap-8 flex-wrap">
            <div>
              ...
              >
                <span className="font-bold text-primary">Shikimori</span> - Terms
                and Conditions
              </Typography>
            </div>
          ...
          <div className="flex flex-col gap-8 mt-4 text-white/80">
            <p>
              Welcome to Shikimori AI Assistant ("Shikimori," "we," "our," or "us").
              ...
              (the "Site"), and any related services provided by Shikimori
            ...
            <div className="flex flex-col gap-4">
              ...
              <ul className="list-inside list-disc flex flex-col gap-4">
                ...
                <li>
                  ...
                  attempting to exploit or harm shikimori or any other user in any
                  way.
                </li>
                <li>
                ...
                <li>
                  Impersonate or attempt to impersonate Shikimori, a Shikimori employee,
                  another user, or any other person or entity.
                </li>
                <li>
                  Engage in any other conduct that restricts or inhibits
                  anyone's use or enjoyment of the Services, or which, as
                  determined by us, may harm Shikimori or users of the Services.
                </li>
              </ul>
            </div>
            <div className="flex flex-col gap-4">
              ...
              <p>
                ...
                design, selection, and arrangement thereof) are owned by Shikimori,
            ...
            <div className="flex flex-col gap-4">
              ...
              <p>
                ...
                ("User Content"), you grant Shikimori a non-exclusive, royalty-free,
            ...
            <div className="flex flex-col gap-4">
              ...
              <p>
                ...
                Shikimori has no control over the contents of those sites or
            ...
            <div className="flex flex-col gap-4">
              ...
              <p>
                ...
                implied. Shikimori does not warrant that the Services will be
                uninterrupted, error-free, or free of viruses or other harmful
                components.
              </p>
              <p>
                In no event will Shikimori, its affiliates, or their licensors
            ...
            <div className="flex flex-col gap-4">
              ...
              <p>
                You agree to defend, indemnify, and hold harmless Shikimori, its
                ...
                Content, any use of the Site’s content, services, Shikimori - Terms
            ...
            <div className="flex flex-col gap-4">
              ...
              <p>
                ...
                Shikimori. Upon termination, your right to use the Services will
            ...
            <div className="flex flex-col gap-4">
              ...
              <p>
                ...
                entire agreement between you and Shikimori regarding the Services,
            ...
            <div className="flex flex-col gap-4">
              ...
              <p>
                No waiver by Shikimori of any term or condition set forth in these
                ...
                failure of Shikimori to assert a right or provision under these
            ...
            <div className="flex flex-col gap-4">
              ...
              <ul className="list-inside list-disc">
                <li>Email: ankurrohonsarkar@gmail.com</li>
      ...
      <div className="w-full py-6 to-black1 mt-12">
        ...
        >
          {new Date().getFullYear()} @ Shikimori. All rights reserved.
        </Typography>
      </div>
    </>
  );
