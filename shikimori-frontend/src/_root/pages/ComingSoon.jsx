        ...
        <div className="w-full max-w-screen-2xl mx-auto p-4 px-6 md:px-8 flex flex-col gap-8 relative z-10">
          ...
          >
            ...
            >
              ...
              >
                Meet <span className="font-bold graText">Shikimori</span>, Your
                AI Buddy!
              </Typography>
              <Typography
                variant="paragraph"
            ...
            >
              <img
                src="https://res.cloudinary.com/didjrpmu0/image/upload/v1721586369/Shikimori_Micchon_pnyikp.png"
          ...
          <div className="flex flex-col-reverse lg:flex-row gap-8 mt-8">
            ...
            >
              ...
              >
                ...
                burning questions, or just a friendly chat, Shikimori is here to
              ...
              <Typography
                ...
                className="font-primary font-normal"
              >
                Shikimori leverages advanced AI technology to understand and
                respond to your queries accurately. No matter the complexity of
                your question, Shikimori has got you covered. By remembering
                your past interactions, Shikimori provides tailored responses
                that align with your preferences and needs. It's like having a
              ...
              >
                ...
                friendly demeanor and intuitive interface, Shikimori ensures
                every interaction is pleasant and productive. You'll find
                Shikimori to be not just a tool, but a companion you can rely
                on.
              </Typography>
            </div>
          </div>
      ...
      >
        <div>
          ...
          <div className="flex flex-col gap-1 items-center justify-center w-full max-w-[350px] mx-auto text-center">
            ...
            >
              Thanks for your interest in Shikimori! We'll notify you as soon as
              we launch.
            </Typography>
            <Button
